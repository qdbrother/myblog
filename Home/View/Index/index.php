<?php
extract($_GET);
    $file_path = $p ? './static/list/index-'.$p.'.shtml' : './static/list/index-1.shtml';
    ...
    <body class="home blog" ondragstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false" onselectstart="event.returnValue=false">
        <div id="page" class="page-site">
            ...
            <header id="header">
                <div class="main-header">
                    <hgroup class="logo-main">
                        <a href="<?php echo MYBLOG_URL;?>" title="回到首页"><img src="/Home/Public/images/logo.png" alt="青岛小哥" title="青岛小哥" height="80px"></a>
                    </hgroup>				
                    <div id="search">
            ...
            <div id="main" class="wrapper">
                <nav class="crumbs">现在位置：<a href="<?php echo MYBLOG_URL;?>" rel="nofollow" title="首页"> 首页</a></nav>
                <div class="clear"></div>
                                        ...
                                        <div class="entry-meta">
                                            <span class="meta-site">
                                                ...
                                                <span class="cat"><i class="icon-cat"></i>
                                                    <a href="article-{$v_group.group_id}-0-0.html" rel="category">
                                                        <foreach name="menu_group" item="v_group">
                                                            <if condition="$v_article.group_id eq $v_group['group_id']">
                                                                {$v_group.group_name}
                                                            </if>
                                                        </foreach>
                                                    </a>
