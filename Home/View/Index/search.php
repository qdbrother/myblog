<?php
    extract($_GET);
    $file_path = $p ? './static/list/article-'.$group_id.'-'.$tab_id.'-'.$p.'.shtml' : './static/list/article-'.$group_id.'-'.$tab_id.'-1.shtml';
...
<meta name="baidu-tc-verification" content="6d71d8bafdd7fc40b4bf3a14af1a7bd9" />
<link rel="shortcut icon" href="<?php echo IMG_URL;?>/fa.jpg"/>
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo IMG_URL;?>/fa.jpg" />
<link rel='stylesheet' id='style-css'  href='<?php echo CSS_URL;?>/style.css' type='text/css' media='all' />
...
<div id="page" class="page-site">
    ...
    <div id="main" class="wrapper">
        <nav class="crumbs">现在位置：
            ...
            <notempty name="tab_info.group_id">
                > 
                <a href="article-{$tab_info.group_id}-0-0.html" rel="nofollow" title="{$tab_info.group_name}"> {$tab_info.group_name}</a>
            </notempty>
            <notempty name="tab_info.tab_id">
                > 
                <a href="article-{$tab_info.group_id}-{$tab_info.tab_id}-0.html" rel="nofollow" title="{$tab_info.tab_name}"> {$tab_info.tab_name}</a>
            </notempty>
        </nav>
        ...
        <div id="primary" class="site-content">
            <div class="primary-site" >
                <foreach name="info" item="v_article" key="i">
                    <article>
                        <section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'">
                            ...
                            <header class="entry-header">
                                ...
                                <h2 class="entry-title">
                                    <a href="article-{$v_article.article_id}.html" target="_self" rel="bookmark"  title="{$v_article.article_title}">{$v_article.article_title}</a>
                                </h2>
                            </header>
                            <div class="entry-content">
                                <notempty name="v_article.pic_url">
                                    <figure class="thumbnail">
                                        <a href="article-{$v_article.article_id}.html" target="_blank" rel="bookmark" title="{$v_article.article_title}">
                                        <img class="home-thumb" src="{$v_article.pic_url}" alt="{$v_article.article_title']}" title="{$v_article.article_title}" /></a>
                                    </figure>
                                </notempty>
                                ...
                                <div class="entry-meta">
                                    <span class="meta-site">
                                        <span class="date"><i class="icon-date"></i><?php echo date('Y-m-d H:i:s',$v_article['create_time']);?></span>
                                        <span class="cat"><i class="icon-cat"></i><a href="article-{$tab_info.group_id}-0-0.html" rel="category">{$tab_info.group_name}</a></span>
                                        <span class="views"><i class="icon-views"></i>访问量 {$v_article.pv}</span>
                                    </span>
                                    <span class="entry-more" id="send_v"><a href="article-{$v_article.article_id}.html" target="_self" rel="bookmark" title="查看详情">查看详情</a></span>
                                </div>
                            </div>
                        </section>
                    </article>
