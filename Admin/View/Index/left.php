                ...
                <td valign=top align=middle>
                    ...
                    <table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                            <td style="padding-left: 30px" background="<?php echo ADMIN_IMG_URL; ?>/menu_bt.jpg">
                                <a class=menuparent onclick=expand({$v.auth_id}) href="javascript:void(0);">{$v.auth_name}</a></td>
                        </tr>
                    ...
                    ?>
                        <tr height=20>
                            ...
                            <td><a class=menuchild href="__MODULE__/{$vv.auth_c}/{$vv.auth_a}" target="right">{$vv.auth_name}</a></td>
                        </tr>
