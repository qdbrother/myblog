...
<html>
    <head>
        ...
        <script type="text/javascript">
            var ue_article = UE.getEditor('container_article');
        </script>
    </head>
    <body>
        <div class="div_head">
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    <td>文章作者</td>
                    <td><input type="text" name="author" value="<?php echo session('admin_name'); ?>"/></td>
                </tr>
                <tr>
                    <td>文章摘要</td>
                    <td>
                        <textarea name="abstract" cols="80" rows="3">
                        </textarea>
                    </td>
                </tr>
                <tr>
                    <td>文章内容</td>
                    <td height="400px">
                        <script id="container_article" name="article_content" type="text/plain">
                        </script>
                    </td>
                </tr>
